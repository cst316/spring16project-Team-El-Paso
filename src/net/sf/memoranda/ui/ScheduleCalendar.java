...
public class ScheduleCalendar extends JTable {
	...
	public ScheduleCalendarCellRenderer renderer = new ScheduleCalendarCellRenderer();
	 ...
	 */
	public ScheduleCalendar(CalendarDate date) {
		super();
		/* table properties */
	...
	public ScheduleCalendar(CalendarDate date, CalendarDate sd, CalendarDate ed) {
		this(date);
	...
	public void set(CalendarDate date) {
		...
		ignoreChange = true;
		this.setModel(new ScheduleCalendarModel());
		ignoreChange = false;
		doSelection();
	}
	...
	/*$Id: JNCalendar.java,v 1.8 2004/11/05 07:38:10 pbielen Exp $*/
public class ScheduleCalendarModel extends AbstractTableModel {

		private String[] dayNames = Local.getWeekdayNames();

		public ScheduleCalendarModel() {
			super();
		}
