...
public class EventDialog extends JDialog implements WindowListener {	
    ...
    public JSpinner durationSpin = new JSpinner(new SpinnerDateModel(new Date(0), null, null, Calendar.MINUTE));
    JLabel lblText = new JLabel(); 
    public JTextArea textField = new JTextArea();
    JLabel locLabel = new JLabel();
    public JTextField locTextField = new JTextField();
    JLabel participantsLabel = new JLabel();
    public JTextArea participantsField = new JTextArea();
    ...
    void jbInit() throws Exception {
        ...
        lblDuration.setText(Local.getString("Duration"));
        lblDuration.setMinimumSize(new Dimension(160,24));
        gbc = new GridBagConstraints();
        ...
        durationSpin.setValue(spinDate);
        gbc = new GridBagConstraints();
        gbc.gridx = 4; gbc.gridy = 0;
        gbc.insets = new Insets(10, 0, 5, 0);
        gbc.anchor = GridBagConstraints.EAST;
        eventPanel.add(durationSpin, gbc);
        lblText.setText(Local.getString("Details"));
        ...
        textField.setMinimumSize(new Dimension(375, 72));
        textField.setPreferredSize(new Dimension(375, 72));
        ...
        locLabel.setText(Local.getString("Location"));
        locLabel.setMinimumSize(new Dimension(120,24));
        gbc = new GridBagConstraints();
        gbc.gridx = 0; gbc.gridy = 3;
        gbc.gridwidth = 3;
        gbc.insets = new Insets(5, 10, 5, 10);
        gbc.anchor = GridBagConstraints.WEST;
        eventPanel.add(locLabel, gbc);
        locTextField.setMinimumSize(new Dimension(375,24));
        locTextField.setPreferredSize(new Dimension(375, 24));
        gbc = new GridBagConstraints();
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        eventPanel.add(locTextField, gbc);
        participantsLabel.setText(Local.getString("Participants"));
        lblText.setMinimumSize(new Dimension(120, 24));
        gbc = new GridBagConstraints();
        ...
        gbc.insets = new Insets(5, 10, 5, 10);
        gbc.anchor = GridBagConstraints.WEST;
        eventPanel.add(participantsLabel, gbc);
        participantsField.setMinimumSize(new Dimension(375, 72));
        participantsField.setPreferredSize(new Dimension(375, 72));
        participantsField.setColumns(30);
        participantsField.setRows(3);
        participantsField.setLineWrap(true);
        participantsField.setWrapStyleWord(true);
        participantsField.setBorder(BorderFactory.createLineBorder(Color.GRAY, 1));
        gbc = new GridBagConstraints();
        ...
        ((JSpinner.DateEditor) durationSpin.getEditor()).getFormat().applyPattern("HH:mm");
