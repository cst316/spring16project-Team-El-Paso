...
/*                        _doc = new Document(_root);
        ...
        public boolean export(String src){
                ...
                File file = new File(this.name+"."+src);
                        ...
                        fwrite.close();
                        JOptionPane.showMessageDialog(null,Local.getString("Document created with success in its Memoranda folder"));
            
            
        } catch (IOException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,Local.getString("Document failed to create"));
        }
