...
public interface TaskList {
    ...
    Task createTask(CalendarDate startDate, CalendarDate endDate, String text, int priority, long effort, String description, String category, String parentTaskId);
